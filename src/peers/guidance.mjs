...
const PEER_CONTEXT_GUIDANCE = "Use peer_context when coordinating long-running peer work to inspect local context usage/pressure and follow its judgement before taking the next task: continue, summarize, compact with local approval, or delegate/start fresh with a context brief.";
