...
const PEER_CONTEXT_GUIDANCE = "Use peer_context when coordinating long-running peer work to inspect local context usage/pressure and follow its judgement before taking the next task: continue, summarize, auto-compact local context when enabled and necessary, or delegate/start fresh with a context brief.";
